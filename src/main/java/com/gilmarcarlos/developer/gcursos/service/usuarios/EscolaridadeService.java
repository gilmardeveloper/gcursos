...
public class EscolaridadeService {
	 ...
	 * 
	 * @param escolaridade entidade que representa uma opção 
	 * @return Escolaridade retorna uma escolaridade
	 * @throws EscolaridadeExisteException se essa opção estiver presente nas permissões, no cadastro de usuários ou eventos
	 * 
	 */
	 ...
	 * 
	 * @param id entidade que representa uma opção 
	 * @throws EscolaridadeExisteException se essa opção estiver presente nas permissões, no cadastro de usuários ou eventos
	 * 
	 */
