package com.gilmarcarlos.developer.gcursos.security.error;
...
public class AutenticacaoErro extends SimpleUrlAuthenticationFailureHandler{
	...
	public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
        ...
        }else if (exception.getMessage().equalsIgnoreCase("Você já é cadastrado")) {
            errorMessage = messages.getMessage("AbstractUserDetailsAuthenticationProvider.registered", null, locale);
        }
