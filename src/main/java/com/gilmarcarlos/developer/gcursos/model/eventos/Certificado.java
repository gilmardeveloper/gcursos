...
public class Certificado implements  Serializable{
	...
	private InputStream gerarPdf() {
		...
		try {
			...
			print = JasperFillManager.fillReport("/home/narclk123/certificado.jasper", parametros, dataSource);  // em produção alterar para "/caminho_da_pasta/" + "arquivo.jasper"
			JRPdfExporter exporter = new JRPdfExporter();
			 
			exporter.setExporterInput(new SimpleExporterInput(print));
			exporter.setExporterOutput(
			  new SimpleOutputStreamExporterOutput("/home/narclk123/certificado.pdf"));  // em produção alterar para "/caminho_da_pasta/arquivo.pdf"
			...
			return new FileInputStream(new File("/home/narclk123/certificado.pdf")); // em produção alterar para "/caminho_da_pasta/" + "arquivo.pdf"
