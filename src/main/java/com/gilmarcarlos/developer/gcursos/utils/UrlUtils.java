...
public class UrlUtils {
	...
	public final static String DASHBOARD_USUARIO_DASHBOARD = "/dashboard/usuario/perfil";
	public final static String DASHBOARD_USUARIO_PERFIL = "/dashboard/usuario/perfil";
